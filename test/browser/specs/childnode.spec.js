...
describe('ChildNodeSpan', () => {
    ...
    it('can be set via element arg', () => {
        const parent = document.querySelector('#childnodetest > .first')
        const startElement = document.querySelector('#childnodetest > .first > #first-start-here')
        const endElement = document.querySelector('#childnodetest > .first > #first-end-here')
