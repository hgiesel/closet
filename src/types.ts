...
import type { Filter as FilterType, WeakFilter as WeakFilterType } from './filterManager/filters'
...
export interface WrapOptions {
    ...
    setTagnames: (o: Record<string, unknown>, newNames: string[]) => Record<string, unknown>
}
