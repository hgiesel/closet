        ...
        with open(user_filepath, 'r') as user_file:
            ...
            amr.make_and_register_interface(
                ...
                getter = lambda id, storage: ami.make_script(
                    storage.name if storage.name is not None else 'Closet Iteration',
                ...
                reset = lambda id, storage: ami.make_script(
                    storage.name if storage.name else 'Closet Iteration',
