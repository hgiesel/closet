...
{% include codeDisplay.md content=shuffling.first_example setups="shuffle_order" buttons=b %}
...
{% include codeDisplay.md content=shuffling.preserve_item_count setups="shuffle_order" buttons=b %}
...
{% include codeDisplay.md content=shuffling.nesting setups="shuffle_order" buttons=b %}
...
{% include codeDisplay.md content=shuffling.onesided_nesting setups="shuffle_order" buttons=b %}
...
{% include codeDisplay.md content=shuffling.deadlock setups="shuffle_order" buttons=b %}
...
{% include codeDisplay.md content=shuffling.japanese setups="fancy_shuffle" buttons=b %}
